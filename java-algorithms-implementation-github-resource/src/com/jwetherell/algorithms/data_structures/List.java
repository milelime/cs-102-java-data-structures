 ...
 * elements, or terms). The number of elements
 * (possibly infinite) is called the length of the sequence. Unlike a set, order
 * matters, and exactly the same elements can appear multiple times at different
